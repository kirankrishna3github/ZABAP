...
*&---------------------------------------------------------------------*
*&---------------------------------------------------------------------*
*&  Include           ZGSP_GLOBAL_GENERATOR_MAIN
**&---------------------------------------------------------------------*
**Title         : ZGSP_GLOBAL_GENERATOR                                *
** Author        :                                                    *
** Company       : cygnet                                   *
** Creation Date : 08.09.2019                                           *
** Transaction   : ZGSP_GSTR_UPD                                          *
** Request ID    :  LRSK901327                                           *
** Ticket No.    : NA                                                   *
*                                       *
** Package       : ZCYGNET                                           *
** Description   : CYGNET Utility                 *
*** NOTE : ASP extractor - Extracting the data

START-OF-SELECTION.

*  IF P_STAGE = 'X'.
*    "extract data in customized table( Done By Cygnet)
    PERFORM GET_DATA.
    PERFORM SET_DATA.
*  ENDIF.
  IF P_RAD3 = 'X'.
    "display in alv (Done By Cygnet)
*    *    PERFORM GET_DATA.
*    PERFORM SET_DATA.
...
*    "Generate CSV file (Done By Cygnet)
  ...
  ENDIF.
  if p_rad4 = 'X'.
    PERFORM FILE_GENERATION.
     CASE g_var_response.
      WHEN 0.
        WRITE: / 'Outward Invoice Successfully Generated'.
      WHEN 1.
        WRITE: / 'Error In FTP Connection During Outward Invoice Generation'.
      WHEN 2.
        WRITE: / 'Error In FTP Command During Outward Invoice Generation'.
      WHEN 3.
        WRITE: / 'Record Not Found During Outward Invoice Generation'.
      WHEN 4.
        WRITE: / 'Record Not Found During Outward Invoice Generation'.
      WHEN 5.
...
*  wa_fcat-col_pos = 3.
*  wa_fcat-tabname = 'L_TAB_OUT_FINAL_API' .
*  wa_fcat-fieldname = 'LIABILITYDISCHARGERETURNPERIOD' .
*  wa_fcat-seltext_m = 'liabilitydischargereturnperiod' .
*  APPEND wa_fcat TO it_fcat.
*  CLEAR wa_fcat.
  ...
  wa_fcat-seltext_m = 'Sub Supply Type Description'.
  APPEND wa_fcat TO it_fcat .
  CLEAR wa_fcat.
 ...
 wa_fcat-seltext_m = 'Transaction Type' .
  ...
  wa_fcat-seltext_m = 'Bill From Address 1'.
  APPEND wa_fcat TO it_fcat .
  CLEAR wa_fcat.
  ...
  wa_fcat-seltext_m = 'Bill From Address 2'.
  APPEND wa_fcat TO it_fcat .
  CLEAR wa_fcat.
 ...
 wa_fcat-seltext_m = 'Dispatch From Other party Name' .
  ...
  wa_fcat-seltext_m = 'Dispatch From Address1' .
  APPEND wa_fcat TO it_fcat .
  CLEAR wa_fcat.
  ...
  wa_fcat-seltext_m = 'Dispatch From Address2'.
  ...
  wa_fcat-seltext_m = 'Bill To: Address1'.
  APPEND wa_fcat TO it_fcat .
  CLEAR wa_fcat.
  ...
  wa_fcat-seltext_m = 'Bill To: Address2'.
  ...
  wa_fcat-seltext_m = 'Ship To: Addrress1'.
  ...
  wa_fcat-seltext_m = 'Ship To: Address2'.
  APPEND wa_fcat TO it_fcat .
  CLEAR wa_fcat.
  ...
  wa_fcat-seltext_m = 'Reverse Chagres'.
  ...
  wa_fcat-seltext_m = 'Shipping Port Code'.
  APPEND wa_fcat TO it_fcat .
  CLEAR wa_fcat.
  ...
  wa_fcat-seltext_m = 'Transporter Date'.
  APPEND wa_fcat TO it_fcat .
  CLEAR wa_fcat.
  ...
  wa_fcat-seltext_m = 'Transporter Time'.
  APPEND wa_fcat TO it_fcat .
  CLEAR wa_fcat.
  ...
  CLEAR wa_fcat.
   ...
   wa_fcat-col_pos = 65.
  wa_fcat-tabname = 'L_TAB_OUT_FINAL_API' .
  wa_fcat-fieldname = 'ORIGINAL_GSTIN' .
  wa_fcat-seltext_m = 'Original GSTIN'.
  APPEND wa_fcat TO it_fcat .
  CLEAR wa_fcat.
...
*  CLEAR wa_fcat.
  ...
  wa_fcat-seltext_m = 'Ut/State Tax Rate'.
  APPEND wa_fcat TO it_fcat .
  CLEAR wa_fcat.
  ...
  wa_fcat-seltext_m = 'UT/State Tax Amount'.
  APPEND wa_fcat TO it_fcat .
  CLEAR wa_fcat.
  ...
  wa_fcat-col_pos = 91.
  wa_fcat-tabname = 'L_TAB_OUT_FINAL_API' .
  wa_fcat-fieldname = 'OTHER_CHARGES' .
  ...
  wa_fcat-seltext_m = 'Eligibility of ITC'.
  APPEND wa_fcat TO it_fcat .
  CLEAR wa_fcat.
   wa_fcat-col_pos = 93.
  wa_fcat-tabname = 'L_TAB_OUT_FINAL_API' .
...
*  CLEAR wa_fcat.
  ...
  wa_fcat-tabname = 'L_TAB_OUT_FINAL_API' .
  wa_fcat-fieldname = 'DOC_STATUS' .
  wa_fcat-seltext_m = 'Document Status'.
  APPEND wa_fcat TO it_fcat .
  CLEAR wa_fcat.
ENDFORM.
